...
For this assignment, I created a workout tracker. This assignment required to create Mongo database with a Mongoose schema and handle routes with Express.
